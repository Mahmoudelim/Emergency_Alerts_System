...
import com.example.emergency_alert_system.user.medicines.Medicine
...
class user_signup : AppCompatActivity() {
 ...
 var  mymedicines : medicine=medicine()
    ...
    var usercontact:user_general_info=user_general_info()
            ...
            if(diabetes.isChecked){
              choronic.add("Diabetes")
                ...
                if(blood_press.isChecked) {
                    ...
                    usercontact.phone_num = phone_num
                    usercontact.password = password
                usercontact.relatives = relativies
                usercontact.relativesphonenum= relativesphonenum
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener { task->
                    if (task.isSuccessful){
                        ...
                        users.document(fullname).set(usercontact)
                        ...
                        users.document("  ${fullname}:medical info ").set(usermedical)
                            .addOnSuccessListener {
